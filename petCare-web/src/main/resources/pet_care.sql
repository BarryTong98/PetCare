...
CREATE TABLE `user` (
  ...
  `phone_number` VARCHAR(25) DEFAULT NULL,
	...
	`image_url` VARCHAR(500) DEFAULT NULL COMMENT '用户头像的URL',
  PRIMARY KEY (`uid`)
...
CREATE TABLE `service_provider` (
  ...
  `business_hours` VARCHAR(50) DEFAULT NULL,
	...
	`recommend` INT(1) DEFAULT 0 COMMENT '是否在首页显示 1 显示 0 不显示',
  PRIMARY KEY (`spid`)
) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
INSERT INTO `service_provider`(`service_provider_name`,`address`,`contact_number`,`type`,`service_content`,`average_price`,`description`,`sales`,`rating`,`region`,`business_hours`,`recommend`)
VALUES ('service_providerA', '1101 S Main St APT 203 Milpitas CA 95035', '02987654321', '1', 'pet hospitals medical check-ups vaccinations sterilisation', 50,'the best pet hospital',500,4.3,'Carlingford','Monday to Friday 9am to 17pm',1);

INSERT INTO `service_provider`(`service_provider_name`,`address`,`contact_number`,`type`,`service_content`,`average_price`,`description`,`sales`,`rating`,`region`,`business_hours`,`recommend`)
VALUES ('service_providerB', '1 Infinite Loop Cupertino CA 95014', '02987654321', '2', 'Pet beauty Bathing Teething Worming ', 80,'the best pet beauty',1000,4.2,'Kogarah','Monday to Friday 9am to 17pm',1);
