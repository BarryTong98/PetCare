        ...
        <el-menu
          ...
          <el-submenu index="1">
            ...
            <template slot="title">
              ...
              <!--文本-->
              <span>
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Health')}}">
                  Health
                </router-link>
              </span>
            </template>
            <el-menu-item-group>
              <el-menu-item index="1-1">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Hospital')}}">
                  Hospital
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-2">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Disease')}}">
                  Disease
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-3">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Sterilization')}}">
                  Sterilization
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-4">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Medical')}}">
                  Medical
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-5">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Vaccination')}}">
                  Vaccination
                </router-link>
              </el-menu-item>
            </el-menu-item-group>
          ...
          <el-submenu index="2">
            ...
            <template slot="title">
              ...
              <span>
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Grooming')}}">
                  Grooming
                </router-link>
              </span>
            </template>
            <el-menu-item-group>
              <el-menu-item index="1-1">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Groom')}}">
                  Groom
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-2">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Washing')}}">
                  Washing
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-3">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Repellent')}}">
                  Repellent
                </router-link>
              </el-menu-item>
              <el-menu-item index="1-4">
                <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Teeth')}}">
                  Teeth
                </router-link>
              </el-menu-item>
            </el-menu-item-group>
          ...
          <el-submenu index="3">
            ...
            <template slot="title">
              ...
              <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Boarding')}}">
                <span>Boarding</span>
              </router-link>
            </template>
            <el-menu-item-group>
              <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Hosting')}}">
                <el-menu-item index="1-1">Hosting</el-menu-item>
              </router-link>
              <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Training')}}">
                <el-menu-item index="1-2">Training</el-menu-item>
              </router-link>
              <router-link :to="{name: 'search', params: {keyword: ' ', address: 'Sydney', checked: changeCheckNum('Playground')}}">
